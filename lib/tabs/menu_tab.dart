              ...
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: const [
                      Text('Mike Tyler', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17)),
                      SizedBox(height: 5.0),
              ...
              child: Row(
                ...
                children: [
                  MaterialButton(
                    ...
                    color: Colors.grey[300],
                    child: const Text('Log out', style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w500)),
                    onPressed: () {},
                  ),
                ],
              ),
