  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.fromLTRB(15.0, 5.0, 0.0, 15.0),
            child: Row(children: [
          ...
          Row(
            children: [
              ...
              Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: const [
                  Text('Mike Tyler', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
                  SizedBox(height: 5.0),
          ...
          const Padding(
            ...
            child: Text('All shortcuts', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 5.0),
                      Text('Feeds', style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold))
                    ],
                  ),
                ),
              ],
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: const [
                      Icon(Icons.shopping_cart, color: Colors.blue, size: 30.0),
                      SizedBox(height: 5.0),
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: const [
                      Icon(Icons.video_library, color: Colors.blue, size: 30.0),
                      SizedBox(height: 5.0),
                      Text('Videos on Watch', style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold))
                    ],
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 5.0),
                      Text('Reels', style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold))
                    ],
                  ),
                ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 10.0),
                    const Text('Settings & Privacy', style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold)),
                  ],
                ),
                const Icon(Icons.arrow_drop_down, size: 30.0),
              ],
            ...
            child: Row(
              ...
              children: [
                MaterialButton(
                  ...
                  color: Colors.grey[200],
                  child: const Text('Log out', style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold)),
                  onPressed: () {},
                ),
              ],
            ),
