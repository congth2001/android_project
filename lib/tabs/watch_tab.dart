...
class _WatchTabState extends State<WatchTab> {
  ...
  void initState() {
    super.initState();
    _controller1 = YoutubePlayerController(initialVideoId: videoUrl1, flags: const YoutubePlayerFlags(
        autoPlay: false,
        mute: false,
    ),);
    _controller2 = YoutubePlayerController(initialVideoId: videoUrl2, flags: const YoutubePlayerFlags(
        autoPlay: false,
        mute: false,
    ),);
  }
