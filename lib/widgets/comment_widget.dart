        ...
        title: Row(
          children: [
            ...
            LikeButton(
                      ...
                      likeBuilder: (isLiked) {
                        return isLiked ? Icon( Icons.thumb_up,color: Colors.blue[700], size: 20.0) : Icon( Icons.thumb_up_outlined,color: Colors.black54, size: 20.0);
                      },
                    )
          ],
        )
      ...
      body: ListView(
        ...
        children: [
          Align(
            ...
            child: TextButton(
              onPressed: (){},
              child: Text('See previous comments...', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black), textAlign: TextAlign.left)
            ),
          ),
          ...List.generate(listOfComments.length, (index) {
                        ...
                        Container(
                            ...
                            child: Text(comment.content,
                                style:
                                    ...
                                    Text(comment.time, style: TextStyle(color: Colors.grey[400], fontSize: 10)),
                      ],
                    ))
              ],
            );
