...
class _FriendSuggestionPage extends State<FriendSuggestionPage> with SingleTickerProviderStateMixin {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Suggestion', style: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.w400)),
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('People You May Know', style: TextStyle(fontSize: 19.0, fontWeight: FontWeight.bold)),
